...
def create_credentials_template():
    ...
    template = """# Ꮢᴏɢᴜᴇ x7 Free Fire Bot Credentials
...
def load_credentials_from_file(filename="Ꮢᴏɢᴜᴇ x7.txt"):
    """
...
📱 Player will see:
"Ꮢᴏɢᴜᴇ x7 wants to join your team"
    ...
    try:
        ...
        fields = {
            ...
            2: {
                ...
                6: "iG:[C][B][FF0000] @Ꮢᴏɢᴜᴇ x7",  # Nickname
                7: 330,                   # Rank
                8: 1000,                  # Field 8
...
Status Code:https://ff.garena.com/profile_like
...
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[9400D3]M A D E B Y [FF0000]Ꮢᴏɢᴜᴇ x7
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFD700] ＦＯＬＬＯＷ    ＭＥ   ＩＮ   [87CEEB]TELEGRAM: [FF0000]@Ꮢᴏɢᴜᴇ x7
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
    fields = {
    1: 5,
    2: {
...
async def convert_kyro_to_your_system(target_uid, chat_id, key, iv, nickname="Ꮢᴏɢᴜᴇ x7", title_id=None):
...
async def send_kyro_title_adapted(chat_id, key, iv, target_uid, nickname="Ꮢᴏɢᴜᴇ x7"):
...
"""
            ...
            # For example:
            title_packet = await convert_kyro_to_your_system(uid, chat_id, key, iv, nickname="Ꮢᴏɢᴜᴇ x7", title_id=title_id)
...
async def noob(target_uid, chat_id, key, iv, nickname="Ꮢᴏɢᴜᴇ x7", title_id=None):
    """EXACT conversion with customizable title ID"""
    try:
        # Use provided title_id or get random one
        if title_id is None:
...
"""
    ...
    try:
        for index, title_id in enumerate(all_titles):
            ...
            # You'll need to use your existing title sending logic here
            # For example:
            title_packet = await noob(uid, chat_id, key, iv, nickname="Ꮢᴏɢᴜᴇ x7", title_id=title_id)
              ...
              # =================== EMOTE DETECTION ONLY ===================
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[B][C][FF0000]█▓▒░░ WELCOME TO Ꮢᴏɢᴜᴇ x7 BOT ░░▒▓█
[FFFF00]»»————-　★　————-««
[FFFFFF]⚡ BOT POWERED BY:[FF0000]X³
[FFFFFF]🎯 STATUS: [FFFF00]ACTIVE 24/7
[FFFFFF]📱 CONTACT: [FFFF00]@Ꮢᴏɢᴜᴇ x7
[FFFF00]»»————-　★　————-««
...
"""
                                ...
                                credentials = load_credentials_from_file("Ꮢᴏɢᴜᴇ x7.txt")
                                if not credentials:
...
[b][i][FFC0CB]youtube: Ꮢᴏɢᴜᴇ x7[/b]

[b][c][FFC0CB]subcribe: my_channel[FFFFFF]
 
[b][i][FFA500]telegram: @Ꮢᴏɢᴜᴇ x7[/b]

[b][c][FFA500]telegram contact: @Ꮢᴏɢᴜᴇ x7[A52A2A]
 
Enjoy the bot my friend.......

[C][B][0000FF] Created by ROSHAN 
Modified by - Ꮢᴏɢᴜᴇ x7
"""
...
async def MaiiiinE():
    ...
    print("📁 Loading credentials from Ꮢᴏɢᴜᴇ x7.txt...")
    credentials = load_credentials_from_file("Ꮢᴏɢᴜᴇ x7.txt")
    
    if not credentials:
        print("❌ Failed to load credentials!")
        print("💡 Please create Ꮢᴏɢᴜᴇ x7.txt with your UID and password")
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 Ꮢᴏɢᴜᴇ x7 BOT - INITIALIZING")
    print("=" * 50)
